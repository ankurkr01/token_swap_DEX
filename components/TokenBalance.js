...
import {ClipboardCheckIcon,ClipboardIcon,PlusIcon} from "@heroicons/react/outline"

// internal imports 
import {TransactionStatus} from "./index"
import {getTokenAdress,increaseAllowance,getTokenBalance} from "../utils/context"
...
const TokenBalance = ({name, walletAddress})=>{
  ...
  async function fetchTokenAddress() {
    const address = await getTokenAdress(name);
